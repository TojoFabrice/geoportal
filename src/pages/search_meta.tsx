...
function Search_Meta(_props: Props): ReactElement {
    ...
    <Layout>
      <Content>
        ...
        <p className="mb-5- dark:text-gray-400">
          Effectuer un recherche dans le Catalogue de métadonnées{" "}
          <a
        ...
        <InstantSearch searchClient={searchClient} indexName="pages_v1">
          <Configure hitsPerPage={10} facetFilters={["typeData:dataset"]} />
