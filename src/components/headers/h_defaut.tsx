...
const H_default = (props: Props) => {
  return (
    <nav className="relative bg-white border-b-2 border-gray-400 text-gray-900 z-50">
      <div className="object-right text-gray-600 font-bold text-right mr-10">
        <Link
          to="/admin"
          target="_blank"
      ...
      <div className="container mx-auto flex justify-between">
        <div className="relative block p-4 lg:p-6 text-xl text-gray-900 font-bold">
          <Link to="/">Portail</Link>
        </div>
        <ul className="flex">
          <li className="hover:bg-gray-400 hover:text-white">
            <Link
              to="/about"
          ...
          <li className="hoverable hover:bg-gray-400 hover:text-white">
            <h2 className="relative block py-6 px-4 lg:p-6 text-sm lg:text-base font-bold hover:bg-gray-400 hover:text-white">
              Données
            </h2>
